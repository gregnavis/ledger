...
seed:
	...
	curl -H "Content-Type: application/json" -X POST -d '{"name":"Consulting Revenue","code":"401","type":"revenue"}' "${URL}/accounts"
	curl -H "Content-Type: application/json" -X POST -d '{"name":"Business Travel","code":"501","type":"expense"}' "${URL}/accounts"
	...
	curl -H "Content-Type: application/json" -X POST -d '{"date":"2016-09-04","description":"Software consulting for Acme Inc.","items":[{"account_code":"101","amount":50000},{"account_code":"401","amount":-50000}]}' "${URL}/transactions"
	curl -H "Content-Type: application/json" -X POST -d '{"date":"2016-09-04","description":"On-site visit to Acme Inc.","items":[{"account_code":"101","amount":-4500},{"account_code":"501","amount":4500}]}' "${URL}/transactions"
