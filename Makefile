...
seed:
	...
	curl -H "Content-Type: application/json" -X POST -d '{"date":"2016-09-1","description":"Record the initial investment","items":[{"account_code":"101","amount":100000},{"account_code":"301","amount":-100000}]}' "${URL}/transactions"
